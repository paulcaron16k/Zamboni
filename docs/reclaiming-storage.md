...
# Azure Blob / ADLS Gen2. Either a connection string on its own, which carries
# the account and the credential together...
ZAMBONI_AZURE_CONNECTION_STRING=...
# ...or an account name plus exactly one credential.
