...
| ZMBNI-19 | User guide and API surface | The documentation two audiences actually need — an administrator running many warehouses and a home gamer running one — plus the public API that makes the first of those possible. Split the runbook by audience. [user_guide.md](user_guide.md) | done | 2026-08-08 |
...
**Story counts:** 95 done · 1 inproject · 16 todo · 1 cancelled  (113 stories)
