...
| ZMBNI-18 | Licence and publication | Apache-2.0, the files a public repo needs, and the order in which to flip the switch. Gated on ZMBNI-905: publishing a repo whose CI has never run invites an assumption we cannot back | done | 2026-08-11 |
...
**Story counts:** 115 done · 0 inproject · 10 todo · 1 cancelled  (126 stories)
